...
fn vec_to_c<T>(mut vec: Vec<T>, c_data: *mut *mut T, c_len: *mut usize) {
    unsafe {
        *c_len = vec.len();
        *c_data = if vec.is_empty() { std::ptr::null_mut() } else { vec.as_mut_ptr() };
...
#[no_mangle]
pub extern fn flouze_error_free(err: *mut c_char) {
    if !err.is_null() {
        unsafe {
...
#[no_mangle]
pub extern fn flouze_sled_repository_temporary(error: *mut *mut c_char) -> *mut c_void {
...
#[no_mangle]
pub extern fn flouze_sled_repository_from_file(path: *const c_char, error: *mut *mut c_char) -> *mut c_void {
...
#[no_mangle]
pub extern fn flouze_sled_repository_destroy(repo: *mut c_void) {
    unsafe { sled_repository_destroy(repo); }
}

#[no_mangle]
pub extern fn flouze_sled_repository_add_account(repo: *mut c_void, account_data: *const u8, account_len: usize, error: *mut *mut c_char) {
...
#[no_mangle]
pub extern fn flouze_sled_repository_list_transactions(
    repo: *mut c_void,
    account_id: *const u8,
...
#[no_mangle]
pub extern fn flouze_sled_repository_add_transaction(
    repo: *mut c_void,
    account_id: *const u8,
    account_id_len: usize,
    tx: *const u8,
...
#[no_mangle]
pub extern fn flouze_sled_repository_get_balance(
    repo: *mut c_void,
    account_id: *const u8,
    account_id_len: usize,
    balance: *mut *mut u8,
...
#[no_mangle]
pub extern fn flouze_json_rpc_client_create(url: *const c_char, error: *mut *mut c_char) -> *mut c_void {
...
#[no_mangle]
pub extern fn flouze_json_rpc_client_get_account_info(
    client: *mut c_void,
    account_id: *const u8,
    account_id_len: usize,
    account: *mut *mut u8,
...
#[no_mangle]
pub extern fn flouze_sync_clone_remote(repo: *mut c_void, client: *mut c_void, account_id: *const u8, account_id_len: usize, error: *mut *mut c_char) {
...
#[no_mangle]
pub extern fn flouze_sync_sync(repo: *mut c_void, client: *mut c_void, account_id: *const u8, account_id_len: usize, error: *mut *mut c_char) {
    let account_id = unsafe { std::slice::from_raw_parts(account_id, account_id_len as usize) };
