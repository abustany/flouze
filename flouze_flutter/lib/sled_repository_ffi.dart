...
typedef flouze_sled_repository_destroy_t = ffi.Void Function(
...
class _SledRepositoryBindings {
  ...
  ffi.Pointer<NativeSledRepository> Function(ffi.Pointer<ffi.Pointer<Utf8>>)
      temporary;
  ffi.Pointer<NativeSledRepository> Function(
      ffi.Pointer<Utf8>, ffi.Pointer<ffi.Pointer<Utf8>>) fromFile;
  ffi.Void Function(ffi.Pointer<NativeSledRepository>, ffi.Pointer<Byte>, int,
      ffi.Pointer<ffi.Pointer<Utf8>>) addAccount;
  ffi.Void Function(ffi.Pointer<NativeSledRepository>, ffi.Pointer<Byte>, int,
      ffi.Pointer<ffi.Pointer<Utf8>>) deleteAccount;
  ffi.Void Function(
      ffi.Pointer<NativeSledRepository>,
      ffi.Pointer<ffi.Pointer<Byte>>,
      ffi.Pointer<ffi.IntPtr>,
      ffi.Pointer<ffi.Pointer<Utf8>>) listAccounts;
  ffi.Void Function(
      ffi.Pointer<NativeSledRepository>,
      ffi.Pointer<Byte>,
      int,
      ffi.Pointer<ffi.Pointer<Byte>>,
      ffi.Pointer<ffi.IntPtr>,
      ffi.Pointer<ffi.Pointer<Utf8>>) listTransactions;
  ffi.Void Function(ffi.Pointer<NativeSledRepository>, ffi.Pointer<Byte>, int,
      ffi.Pointer<Byte>, int, ffi.Pointer<ffi.Pointer<Utf8>>) addTransaction;
  ffi.Void Function(
      ffi.Pointer<NativeSledRepository>,
      ffi.Pointer<Byte>,
      int,
...
class _SledRepositoryHelpers {
  ...
  static void addAccount(
          ffi.Pointer<NativeSledRepository> ptr, Account account) =>
      addAccountBytes(ptr, account.writeToBuffer());

  static void addAccountBytes(
      ffi.Pointer<NativeSledRepository> ptr, Uint8List account) {
  ...
  static void deleteAccountBytes(
      ffi.Pointer<NativeSledRepository> ptr, Uint8List accountId) {
    withError((errPtr) => withCBytes(
        accountId,
        (data, len) =>
  ...
  static List<Account> listAccounts(ffi.Pointer<NativeSledRepository> ptr) =>
      AccountList.fromBuffer(listAccountsBytes(ptr)).accounts;

  static Uint8List listAccountsBytes(ffi.Pointer<NativeSledRepository> ptr) =>
      withOutCBytes((accountDataPtr, accountDataLenPtr) => withError((errPtr) =>
          _sledRepositoryBindings.listAccounts(
              ptr, accountDataPtr, accountDataLenPtr, errPtr))).bytes ??
      Uint8List(0);

  static List<Transaction> listTransactions(
          ffi.Pointer<NativeSledRepository> ptr, List<int> accountId) =>
      TransactionList.fromBuffer(listTransactionsBytes(ptr, accountId))
          .transactions;

  static Uint8List listTransactionsBytes(
          ffi.Pointer<NativeSledRepository> ptr, List<int> accountId) =>
      withOutCBytes((txDataPtr, txDataLen) => withError((errPtr) => withCBytes(
          Uint8List.fromList(accountId),
          (cAccountId, cAccountIdLen) =>
              _sledRepositoryBindings.listTransactions(ptr, cAccountId,
                  cAccountIdLen, txDataPtr, txDataLen, errPtr)))).bytes ??
      Uint8List(0);

  static void addTransaction(ffi.Pointer<NativeSledRepository> ptr,
          List<int> accountId, Transaction transaction) =>
      addTransactionBytes(
          ptr, Uint8List.fromList(accountId), transaction.writeToBuffer());

  static void addTransactionBytes(ffi.Pointer<NativeSledRepository> ptr,
          Uint8List accountId, Uint8List transaction) =>
      withError((errPtr) => withCBytes(
          accountId,
          (accountId, accountIdLen) => withCBytes(
              transaction,
              (txData, txDataLen) => _sledRepositoryBindings.addTransaction(
                  ptr, accountId, accountIdLen, txData, txDataLen, errPtr))));

  static Map<List<int>, int> getBalance(
          ffi.Pointer<NativeSledRepository> ptr, List<int> accountId) =>
      Map.fromEntries(Balance.fromBuffer(
              getBalanceBytes(ptr, Uint8List.fromList(accountId)))
          .entries
          .map((entry) => MapEntry(entry.person, entry.balance.toInt())));

  static Uint8List getBalanceBytes(
      ffi.Pointer<NativeSledRepository> ptr, Uint8List accountId) {
    final res = withOutCBytes((balanceDataPtr, balanceDataLen) => withError(
        (errPtr) => withCBytes(
            Uint8List.fromList(accountId),
            (cAccountId, cAccountIdLen) => _sledRepositoryBindings.getBalance(
                ptr,
                cAccountId,
                cAccountIdLen,
                balanceDataPtr,
...
class SledRepository extends IsolateProxy {
    ...
    IsolateProxy.handleCalls(
      ...
      () {
        if (mainParams.path == null) {
          return withError(
              (errPtr) => _sledRepositoryBindings.temporary(errPtr));
        } else {
          return withError((errPtr) => withCStr(mainParams.path,
              (cPath) => _sledRepositoryBindings.fromFile(cPath, errPtr)));
        }
      },
      _handleCall,
    );
  ...
  static dynamic _handleCall(dynamic instance, Call call) {
    ...
    switch (call.runtimeType) {
      ...
      case _SledRepositoryAddAccount:
        return _SledRepositoryHelpers.addAccountBytes(
            ptr, (call as _SledRepositoryAddAccount).account);
      case _SledRepositoryDeleteAccount:
        return _SledRepositoryHelpers.deleteAccountBytes(
            ptr, (call as _SledRepositoryDeleteAccount).accountId);
      case _SledRepositoryListTransactions:
        return _SledRepositoryHelpers.listTransactionsBytes(
            ptr, (call as _SledRepositoryListTransactions).accountId);
      case _SledRepositoryAddTransaction:
        final addCall = (call as _SledRepositoryAddTransaction);
        return _SledRepositoryHelpers.addTransactionBytes(
            ptr, addCall.accountId, addCall.transaction);
      case _SledRepositoryGetBalance:
        return _SledRepositoryHelpers.getBalanceBytes(
  ...
  factory SledRepository.temporary() =>
      SledRepository._(_SledRepositoryMainParams(null));

  factory SledRepository.fromFile(String path) =>
      SledRepository._(_SledRepositoryMainParams(path));
  ...
  Future<void> deleteAccount(List<int> accountId) =>
      call(_SledRepositoryDeleteAccount(Uint8List.fromList(accountId)))
          .then((_) {
        Events.post(Events.ACCOUNT_LIST_CHANGED);
      });

  Future<List<Account>> listAccounts() => call(_SledRepositoryListAccounts())
      .then((bytes) => AccountList.fromBuffer(bytes).accounts);

  Future<List<Transaction>> listTransactions(List<int> accountId) =>
      call(_SledRepositoryListTransactions(Uint8List.fromList(accountId)))
  ...
  Future<void> addTransaction(List<int> accountId, Transaction transaction) =>
      call(_SledRepositoryAddTransaction(
          Uint8List.fromList(accountId), transaction.writeToBuffer()));

  Future<Map<List<int>, int>> getBalance(List<int> accountId) =>
      call(_SledRepositoryGetBalance(Uint8List.fromList(accountId))).then(
